...
- Engineers using the extension are already familiar with the existing sphinx-need-sysml conventions (Def vs Usage naming, ID prefix conventions, owned_by composition, satisfies/refines/allocates traceability links).
